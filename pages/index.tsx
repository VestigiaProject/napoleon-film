      ...
      <div className="relative z-10 pt-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 min-h-[calc(100vh-64px)]">
          <div className="py-16 font-mono text-white">
            ...
            {/* Action Buttons */}
            <div className="flex flex-col items-center sm:flex-row sm:justify-center space-y-4 sm:space-y-0 sm:space-x-6">
              <Link
                href="/shots"
                className="w-full sm:w-auto px-8 py-3 bg-transparent text-white font-mono uppercase tracking-wider text-sm hover:bg-white hover:bg-opacity-10 transition-colors border-2 border-white text-center"
              >
                Contribute
              </Link>
              <a
                ...
                className="w-full sm:w-auto px-8 py-3 bg-transparent text-white font-mono uppercase tracking-wider text-sm hover:bg-white hover:bg-opacity-10 transition-colors border-2 border-white flex items-center justify-center space-x-2"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
